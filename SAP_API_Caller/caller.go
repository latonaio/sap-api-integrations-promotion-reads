...
import (
	...
	"io/ioutil"
	"net/http"
	sap_api_output_formatter "sap-api-integrations-promotion-reads/SAP_API_Output_Formatter"
	"strings"
	"sync"
...
func (c *SAPAPICaller) PromotionCollection(iD string) {
	promotionCollectionData, err := c.callPromotionSrvAPIRequirementPromotionCollection("PromotionCollection", iD)
	if err != nil {
		c.log.Error(err)
		return
	}
